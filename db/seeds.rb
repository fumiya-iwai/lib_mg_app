...
Rental.create!(book_id: 17, user_id: 2, rented_date: Date.new(2022, 9, 2), scheduled_return_date: Date.new(2022, 9, 9))
Rental.create!(book_id: 16, user_id: 2, rented_date: Date.new(2022, 9, 2), scheduled_return_date: Date.new(2022, 9, 9))
Rental.create!(book_id: 15, user_id: 2, rented_date: Date.new(2022, 9, 2), scheduled_return_date: Date.new(2022, 9, 9))